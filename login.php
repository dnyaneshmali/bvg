...
<html lang="en">
   <?php $root = $_SERVER['DOCUMENT_ROOT'].'/bvg/';
         ...
         <div class="container login-page">
            <div class="row">
               <div class="panel panel-default">
                ...
                <!--  <a href="http://localhost/bvg/index.php"><img src="images/am_logo.png" alt="logo"></a>

                  </div>  -->
                  <div class = "panel-body">
                     <div ng-app='bvgLogin' ng-controller='loginCtrl'>
